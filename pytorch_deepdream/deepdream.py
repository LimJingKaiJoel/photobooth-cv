...
import pytorch_deepdream.utils.utils as utils
from pytorch_deepdream.utils.constants import *
import pytorch_deepdream.utils.video_utils as video_utils

model = utils.fetch_and_prepare_model(SupportedModels.VGG16_EXPERIMENTAL.name, SupportedPretrainedWeights.IMAGENET.name, DEVICE)
...
# input_img is a numpy array (image)
def change_to_deepdream(input_img, img_width, num_iters, lr):
    ...
    args.num_gradient_ascent_iterations = num_iters
    args.lr = lr
